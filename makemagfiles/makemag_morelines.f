      ...
      real jnk,chitot,routot,chi(30,120000),rou(30,120000),jnk2
      real work(2,14),chis(30),rous(30),Xs(30),Ys(30)
      real x(30,120000),y(30,120000),x1,y1
      real iter(30,120000),sky(30,120000),M(30,120000),Merr(30,120000)
      real T(30,120000),Terr(30,120000),chitot2,routot2,chiavg,rouavg
      integer i,j,k,id(30,120000),count,FMAX,LMAX(30),id1
